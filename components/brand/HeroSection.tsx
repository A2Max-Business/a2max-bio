...
export function HeroSection() {
  return (
    <div className="relative w-full h-[55vh] min-h-[480px] max-h-[600px] flex flex-col justify-end overflow-hidden pb-12">
      ...
      <div className="relative z-10 px-6 mt-auto">
        ...
        <h1 className="text-[28px] leading-[1.2] font-semibold text-white mb-4 pr-4">
          Negócios <br />
          mais preparados <br />
          para o <span className="text-laranja-energia">próximo nível.</span>
        </h1>

        <p className="text-sm leading-relaxed text-gray-300 font-light pr-6">
